...
public class MonsterRoom extends Room {
    ...
    public RoomState onRoomEnter() {
        if (roomState == RoomState.UNTOUCHED)
            Interface.printText("Um elemental de(a) %s apareceu", enemy.getElement().getName());
        return roomState;
    }
    ...
    private void playerItemAction() {
        Interface.printText("Ainda nao pode usar item");
    }
    ...
    private void playerAttackAction() {
        ...
        do {
            try {
                ...
                Interface.printText("Você deve escolher um numero entre 0 e 3");
            } catch (NoManaException e) {
